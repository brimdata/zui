...
export type SpacesAction = SPACES_SET | SPACES_DETAIL | SPACES_RENAME | SPACES_INGEST_PROGRESS | SPACES_INGEST_WARNING_APPEND | SPACES_INGEST_WARNING_CLEAR | SPACES_REMOVE | SPACES_INGEST_SNAPSHOT;
