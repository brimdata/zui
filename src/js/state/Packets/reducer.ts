...
export default function reducer(state: PacketsState = init, action: PacketsAction): PacketsState {
  switch (action.type) {
...
const updateDownload = (state: Download[], uid: string, newProps: Object): Download[] => {
