...
export const getConnectionId = activeTabSelect(state => state.current.connectionId);

export const mustGetConnection = createSelector<State, void, Cluster, ClustersState, Id>(Clusters.raw, getConnectionId, (conns, id) => {
...
export const mustGetSpace = createSelector<State, void, Space, SpacesState, Id, Id>(Spaces.raw, getConnectionId, getSpaceId, (spaces, connId, spaceId) => {
