...
export type SearchBarAction = SEARCH_BAR_CLEAR | SEARCH_BAR_RESTORE | SEARCH_BAR_INPUT_CHANGE | SEARCH_BAR_PIN | SEARCH_BAR_PIN_EDIT | SEARCH_BAR_PIN_REMOVE | SEARCH_BAR_PIN_REMOVE_ALL | SEARCH_BAR_PINS_SET | SEARCH_BAR_PARSE_ERROR | SEARCH_BAR_SUBMIT | SEARCH_BAR_TARGET_SET;
