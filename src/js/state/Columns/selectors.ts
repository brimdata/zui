...
const getCurrentTableColumns = createSelector<State, void, TableColumns, ViewerColumns, ColumnsState, Log[], any>(Viewer.getColumns, getColumns, Viewer.getLogs, (viewerColumns, columnSettings, logs) => {
