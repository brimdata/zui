...
export type ViewerAction = VIEWER_CLEAR | VIEWER_SPLICE | VIEWER_STATUS | VIEWER_RECORDS | VIEWER_SET_RECORDS | VIEWER_COLUMNS | VIEWER_SET_COLUMNS | VIEWER_END_STATUS | VIEWER_SCROLL | VIEWER_SELECT | VIEWER_SELECT_MULTI | VIEWER_SELECT_RANGE | VIEWER_SELECT_NEXT | VIEWER_SELECT_PREV | VIEWER_SELECT_RANGE_NEXT | VIEWER_SELECT_RANGE_PREV | VIEWER_SELECT_ALL;
