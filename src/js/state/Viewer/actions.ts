...
import { VIEWER_CLEAR, VIEWER_COLUMNS, VIEWER_END_STATUS, VIEWER_RECORDS, VIEWER_SCROLL, VIEWER_SELECT, VIEWER_SELECT_ALL, VIEWER_SELECT_MULTI, VIEWER_SELECT_NEXT, VIEWER_SELECT_PREV, VIEWER_SELECT_RANGE, VIEWER_SELECT_RANGE_NEXT, VIEWER_SELECT_RANGE_PREV, VIEWER_SET_COLUMNS, VIEWER_SET_RECORDS, VIEWER_SPLICE, VIEWER_STATUS, ViewerColumns, ViewerStatus } from "./types";
...
export const setStatus = (tabId: string, status: SearchStatus): VIEWER_STATUS => {
  return { type: "VIEWER_STATUS", status, tabId };
};

export const setEndStatus = (tabId: string, status: ViewerStatus): VIEWER_END_STATUS => {
  return { type: "VIEWER_END_STATUS", status, tabId };
};

export const appendRecords = (tabId: string | null | undefined, records: RecordData[]): VIEWER_RECORDS => {
  return { type: "VIEWER_RECORDS", records, tabId };
};

export const setRecords = (tabId?: string, records: RecordData[]): VIEWER_SET_RECORDS => {
  return { type: "VIEWER_SET_RECORDS", records, tabId };
};

export const updateColumns = (tabId: string, columns: ViewerColumns): VIEWER_COLUMNS => {
  return {
    type: "VIEWER_COLUMNS",
    columns,
    tabId
...
export const setColumns = (tabId: string, columns: ViewerColumns): VIEWER_SET_COLUMNS => {
  return {
