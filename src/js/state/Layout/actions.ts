...
import { LAYOUT_INVESTIGATION_VIEW_SET, InvestigationView, LAYOUT_LEFT_SIDEBAR_HIDE, LAYOUT_LEFT_SIDEBAR_SHOW, LAYOUT_LEFT_SIDEBAR_TOGGLE, LAYOUT_LEFT_SIDEBAR_WIDTH_SET, LAYOUT_RIGHT_SIDEBAR_HIDE, LAYOUT_RIGHT_SIDEBAR_SHOW, LAYOUT_RIGHT_SIDEBAR_TOGGLE, LAYOUT_RIGHT_SIDEBAR_WIDTH_SET, LAYOUT_HISTORY_HEIGHT_SET, LAYOUT_SPACES_HEIGHT_SET, LAYOUT_HISTORY_TOGGLE, LAYOUT_SPACES_TOGGLE } from "./types";
...
export default {
  ...
  setInvestigationView: (view: InvestigationView): LAYOUT_INVESTIGATION_VIEW_SET => ({
