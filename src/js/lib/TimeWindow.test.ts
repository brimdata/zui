...
test("duration as seconds", () => {
  const window = [new Date(2000, 1, 15, 12, 30, 0), new Date(2000, 1, 15, 12, 30, 45)];
...
test("duration as ms", () => {
  const window = [new Date(2000, 1, 15, 12, 30, 0, 0), new Date(2000, 1, 15, 12, 30, 45, 0)];
...
test("humanDuration", () => {
  const window = [new Date(2000, 1, 15, 12, 30, 0, 0), new Date(2000, 1, 15, 15, 30, 45, 0)];
...
test("floorAndCeil", () => {
  const window = [new Date(2000, 1, 15, 12, 30, 0, 0), new Date(2000, 1, 15, 13, 30, 45, 0)];

  const newWindow = TimeWindow.floorAndCeil(window, "minutes");

  expect(newWindow).toEqual([new Date(2000, 1, 15, 12, 30, 0, 0), new Date(2000, 1, 15, 13, 30, 59, 999)]);
});
...
test("shift forward", () => {
  ...
  expect(newWindow).toEqual([new Date(2000, 1, 15, 12, 30, 1, 0), new Date(2000, 1, 15, 13, 30, 46, 0)]);
});
...
test("shift backwards", () => {
  ...
  expect(newWindow).toEqual([new Date(2000, 1, 15, 12, 29, 59, 0), new Date(2000, 1, 15, 13, 30, 44, 0)]);
});