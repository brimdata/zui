...
export class UnauthorizedError extends AppError {
  ...
  static is(e: RawError) {
    if (e instanceof Error && e.message.match(/Need boom credentials/)) return true;
...
export const KNOWN_ERRORS = [SearchError, InvalidUrlError, ZqVersionError, UnauthorizedError, NetworkError, NoSpacesError, SpaceNotFoundError, NotFoundError, InternalServerError];