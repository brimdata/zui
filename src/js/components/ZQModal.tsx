...
export default function ZQModal() {
  ...
  return <ModalBox buttons={[{ label: "Copy", click: copyToClip }, { label: "Done", click: closeModal => closeModal() }]} name="zq" className="zq-modal" title="zq command" {...reactElementProps("zqModal")}>
      <ZQModalContents />
    </ModalBox>;
}
