...
export default function NewConnectionModal() {
  ...
  const buttons = [{ label: "Cancel", click: closeModal => closeModal() }, { label: "Connect", click: onSubmit }];

  return <StyledModalBox title="New Connection" name="new-connection" buttons={buttons} onClose={onClose}>
      <TextContent>
        <SignInForm>
          <form ref={formRef}>
            <BrimTextLogo />
