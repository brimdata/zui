...
export function Input({
  ...
  return <div className={classes}>
      ...
      <input {...inputProps} onFocus={onFocus} onBlur={onBlur} onChange={onChange} />
    </div>;
}
...
export function InputCheckbox({
  ...
  return <div className={classes}>
      <label>
        <input type="checkbox" {...inputProps} onFocus={onFocus} onBlur={onBlur} />{" "}
        {label}
      </label>
    </div>;
}

export function InputSubmit({ ...inputProps
}: Props) {
  return <div className="input-submit">
