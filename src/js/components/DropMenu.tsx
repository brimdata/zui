...
export default class DropMenu extends React.Component<Props, State> {
  ...
  getMenu() {
    ...
    if (this.props.dim) {
      return <DimPortal style={this.state.style} isOpen={this.state.isOpen} onClose={this.close}>
          <Menu onClose={this.close} onChange={this.props.onChange} />
        </DimPortal>;
    } else {
      return <Portal style={this.state.style} isOpen={this.state.isOpen} onClose={this.close}>
          <Menu onClose={this.close} onChange={this.props.onChange} />
        </Portal>;
    }
  }
  ...
  render() {
    return <div className={this.props.className} onClick={this.open}>
        {this.props.children}
        {this.getMenu()}
      </div>;
  }
