...
* Use Pools in Zed Lakes for backend storage rather than Spaces (#1589, #1601, #1633, #1676, #1696, #1710, #1712)
...
* Offer the option to migrate Spaces to Pools when new Brim launches ([wiki article](https://github.com/brimdata/brim/wiki/Migration-of-Spaces-%28v0.25.0-%29)) (#1621, #1587, #1636, #1641, #1640, #1657, #1671, #1682)
