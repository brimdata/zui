## v0.24.0
* Update zq to [v0.29.0](https://github.com/brimdata/zq/releases/tag/v0.29.0)
...
* Update zq to [v0.28.0](https://github.com/brimdata/zq/releases/tag/v0.28.0)
...
* Update zq to [v0.27.1](https://github.com/brimdata/zq/releases/tag/v0.27.1) (follow that link for details of additional changes that may affect Brim)

## v0.21.1
* Update zq to [v0.26.0](https://github.com/brimdata/zq/releases/tag/v0.26.0), which fixes an issue that was causing pcap import failures, and also delivers other enhancements
...
* Update zq to [v0.25.0](https://github.com/brimdata/zq/releases/tag/v0.25.0)
...
## v0.20.0
* Update zq to [v0.24.0](https://github.com/brimdata/zq/releases/tag/v0.24.0)
* Begin bundling the same Zeek artifact referenced in [zq's `package.json`](https://github.com/brimdata/zq/blob/master/package.json) (#1215)
...
[`zq` v0.23.0 release notes](https://github.com/brimdata/zq/releases/tag/v0.23.0),
...
* Update zq to [v0.23.0](https://github.com/brimdata/zq/releases/tag/v0.23.0)
...
* Binaries for [`pcap`](https://github.com/brimdata/zq/blob/master/cmd/pcap/README.md), [`zapi`](https://github.com/brimdata/zq/blob/master/cmd/zapi/README.md), and [`zar`](https://github.com/brimdata/zq/blob/master/ppl/cmd/zar/README.md) are now bundled with Brim (#1098)
...
## v0.18.0
* Update zq to [v0.22.0](https://github.com/brimdata/zq/releases/tag/v0.22.0)
...
## v0.17.0
* Update zq to [v0.21.0](https://github.com/brimdata/zq/releases/tag/v0.21.0)
...
## v0.16.0
* Update zq to [v0.20.0](https://github.com/brimdata/zq/releases/tag/v0.20.0)
...
* Fix an issue where clicking a link to [ZQL docs](https://github.com/brimdata/zq/tree/master/docs/language) opened an unusable window (#1030)
...
* Add the ability to connect Brim to a remote [`zqd`](https://github.com/brimdata/zq/tree/master/ppl/cmd/zqd) (#1007)

## v0.15.1
* Update zq to [v0.19.1](https://github.com/brimdata/zq/releases/tag/v0.19.1) (fixes an issue with excess characters in Space names after upgrade)
* Fix an issue where opening Log Detail as the first action in a freshly-launched Brim threw an error (#1006)

## v0.15.0
* Update zq to [v0.19.0](https://github.com/brimdata/zq/releases/tag/v0.19.0)
...
## v0.14.0
* Update zq to [v0.18.0](https://github.com/brimdata/zq/releases/tag/v0.18.0)
...
* Add the [Zealot Client](https://github.com/brimdata/brim/blob/master/zealot/README.md) for communicating with [`zqd`](https://github.com/brimdata/zq/tree/master/ppl/cmd/zqd) via the REST API (#934)
...
## v0.13.0
* Update zq to [v0.17.0](https://github.com/brimdata/zq/releases/tag/v0.17.0)
...
## v0.12.0
* Update zq to [v0.16.0](https://github.com/brimdata/zq/releases/tag/v0.16.0)

## v0.11.0
* Update zq to [v0.15.0](https://github.com/brimdata/zq/releases/tag/v0.15.0), which fixes [an issue with ZNG export](https://github.com/brimdata/brim/issues/814#issuecomment-636130351)
...
## v0.10.0
* Update zq to [v0.14.0](https://github.com/brimdata/zq/releases/tag/v0.14.0)
...
* Update zq to [v0.13.1](https://github.com/brimdata/zq/releases/tag/v0.13.1) (#756)

## v0.9.0

* **NOTE**: Prior state such as Search History will be lost on upgrade to this version
* Update zq to [v0.13.0](https://github.com/brimdata/zq/releases/tag/v0.13.0) (#750)
...
## v0.8.0
* Update zq to [v0.11.1](https://github.com/brimdata/zq/releases/tag/v0.11.1) (fixes an issue that was causing the histogram to draw incorrectly) (#640)
