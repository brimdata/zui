...
* Update Zeek to [v3.2.0-dev-brim2](https://github.com/brimsec/zeek/releases/tag/v3.2.0-dev-brim2). This release runs faster on Windows, but also makes it such that pcap import no longers on macOS versions prior to 10.14. (#819)
