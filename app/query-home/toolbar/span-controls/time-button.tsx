...
import {isString} from "src/js/lib/is"
import {TimeArg} from "src/js/state/Search/types"
...
const TimeButton = ({timeArg, prevTimeArg, onChange, icon}: Props) => {
